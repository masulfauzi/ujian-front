<template>
    ...
    <aside
        ...
        <nav v-else class="space-y-1">
            ...
            <router-link to="/admin/mapel" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/jurusan" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/kelas" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/bank-soal" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/peserta" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/jadwal" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
            ...
            <router-link to="/admin/nilai" :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 font-semibold hover:translate-x-1 duration-200',
